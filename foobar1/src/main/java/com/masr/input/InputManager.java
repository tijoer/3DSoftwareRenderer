...
//					new Point(0, 0), "invisible");
	...
	/**
	 * Maps a InputAction to a specific key. The key codes are defined in
	 * java.awt.KeyEvent. If the key already has a InputAction mapped to it, the
	 * new InputAction overwrites it.
	 */
	...
	/**
	 * Maps a InputAction to a specific mouse action. The mouse codes are defined
	 * herer in InputManager (MOUSE_MOVE_LEFT, MOUSE_BUTTON_1, etc). If the
	 * mouse action already has a InputAction mapped to it, the new InputAction
	 * overwrites it.
	 */
	public void mapToMouse(InputAction gameAction, int mouseCode) {
	 ...
	 */
	public void clearMap(InputAction gameAction) {
	 ...
	 * InputAction. Each entry in the List is a String.
	 */
