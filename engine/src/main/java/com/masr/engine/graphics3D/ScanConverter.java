...
import com.masr.engine.math3D.Polygon3D;
    ...
    */
    public boolean convert(Polygon3D polygon) {
        ...
        for (int i=0; i<numVertices; i++) {
            ...
            int startY = (int) Math.max(Math.ceil(v1.y), minY);
            int endY = (int) Math.min(Math.ceil(v2.y)-1, maxY);
            ...
            if (dx == 0) {
                ...
                */
                ...
                if (endX < minX) {
                    int yInt = (int) Math.ceil(v1.y + (minX - v1.x) /
                        gradient);
                    ...
                    int yInt = (int) Math.ceil(v1.y + (maxX - v1.x) /
                        gradient);
                    yInt = Math.max(yInt, startY);
                    while (endY >= yInt) {
