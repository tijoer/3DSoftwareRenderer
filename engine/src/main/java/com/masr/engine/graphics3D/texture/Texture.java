...
public abstract class Texture {
	 ...
	 */
	public static Texture createTexture(String filename) throws IOException {
		try {
			return createTexture(filename, false);
		} catch (IOException ex) {
			throw new IOException("Filename: " + filename, ex);
		}
	}
	...
	public static Texture createTexture(String filename,
		...
		try {
			...
			return createTexture(ImageIO.read(is), shaded);
		} catch (Exception ex) {
			throw new IOException("Filename: " + filename, ex);
		}
	}
