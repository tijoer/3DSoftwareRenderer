...
//									.toString());
				...
				// Parsing rotation quaternion.
					...
					// float
					model.getJoints()[jointIndex].getBindPoseOrient().x = (float) st.nval;
//					System.out.println(" @ (position = " + pointer + ") "
//							+ st.nval);
					...
					model.getJoints()[jointIndex].getBindPoseOrient().y = (float) st.nval;
//					System.out.println(" @ (position = " + pointer + ") "
//							+ st.nval);
					...
					model.getJoints()[jointIndex].getBindPoseOrient().z = (float) st.nval;
//					System.out.println(" @ (position = " + pointer + ") "
//							+ st.nval);
