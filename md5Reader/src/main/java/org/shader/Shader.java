...
//    GL2 gl;
//
//    public Shader(GL2 gl, String vertexfile, String fragmentfile) throws CompilerException, LinkerException {
//        this.gl = gl;
...
//        gl.glGetProgramiv(progid, GL2.GL_LINK_STATUS, linkerror, 0);
//        if (linkerror[0] != GL2.GL_TRUE) {
//            //error while linking, throw the appropriate exception
//            // first get the lenght of the error log
//            gl.glGetProgramiv(progid, GL2.GL_INFO_LOG_LENGTH, linkerror, 0);
//            // then the log itself
...
//        gl.glUniform1iARB(gl.glGetUniformLocation(progid, name), value);
//    }
//
